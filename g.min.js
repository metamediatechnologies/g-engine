...
d,e,f,g,i){b.log("main(): Enter");b.system=new b.System(a,d,e,f,g||1);b.ready=!0;(new (i||b.Loader)(c||b.Game,b.resources)).load();b.log("main(): Exit")}});b.module("g.entity").requires("g.animation","g.main").defines(function(){b.Entity=b.Class.extend({id:0,settings:{},size:{x:16,y:16},offset:{x:0,y:0},pos:{x:0,y:0},last:{x:0,y:0},vel:{x:0,y:0},accel:{x:0,y:0},friction:{x:0,y:0},maxVel:{x:100,y:100},zIndex:0,gravityFactor:1,standing:!1,bounciness:0,minBounceVelocity:40,anims:{},animSheet:null,currentAnim:null,
health:10,type:0,checkAgainst:0,collides:0,init:function(a,c,d){this.id=++b.Entity._lastId;this.pos.x=a;this.pos.y=c;b.merge(this,d)},addAnim:function(a,c,d,e){if(!this.animSheet)throw"No animSheet to add the animation "+a+" to.";c=new b.Animation(this.animSheet,c,d,e);this.anims[a]=c;if(!this.currentAnim)this.currentAnim=c;return c},update:function(){this.last.x=this.pos.x;this.last.y=this.pos.y;this.vel.y+=b.game.gravity*b.system.tick*this.gravityFactor;this.vel.x=this.getNewVelocity(this.vel.x,
this.accel.x,this.friction.x,this.maxVel.x);this.vel.y=this.getNewVelocity(this.vel.y,this.accel.y,this.friction.y,this.maxVel.y);this.handleMovementTrace(b.game.collisionMap.trace(this.pos.x,this.pos.y,this.vel.x*b.system.tick,this.vel.y*b.system.tick,this.size.x,this.size.y));this.currentAnim&&this.currentAnim.update()},getNewVelocity:function(a,c,d,e){if(c)return(a+c*b.system.tick).limit(-e,e);else if(d)return c=d*b.system.tick,a-c>0?a-c:a+c<0?a+c:0;return a.limit(-e,e)},handleMovementTrace:function(a){this.standing=
!1;if(a.collision.y)if(this.bounciness>0&&Math.abs(this.vel.y)>this.minBounceVelocity)this.vel.y*=-this.bounciness;else{if(this.vel.y>0)this.standing=!0;this.vel.y=0}if(a.collision.x)this.bounciness>0&&Math.abs(this.vel.x)>this.minBounceVelocity?this.vel.x*=-this.bounciness:this.vel.x=0;this.pos=a.pos},draw:function(){this.currentAnim&&this.currentAnim.draw(this.pos.x.round()-this.offset.x-b.game.screen.x,this.pos.y.round()-this.offset.y-b.game.screen.y)},kill:function(){b.game.removeEntity(this)},
receiveDamage:function(a){this.health-=a;this.health<=0&&this.kill()},touches:function(a){return!(this.pos.x>a.pos.x+a.size.x||this.pos.x+this.size.x<a.pos.x||this.pos.y>a.pos.y+a.size.y||this.pos.y+this.size.y<a.pos.y)},distanceTo:function(a){var b=this.pos.x+this.size.x/2-(a.pos.x+a.size.x/2),a=this.pos.y+this.size.y/2-(a.pos.y+a.size.y/2);return Math.sqrt(b*b+a*a)},angleTo:function(a){return Math.atan2(a.pos.y+a.size.y/2-(this.pos.y+this.size.y/2),a.pos.x+a.size.x/2-(this.pos.x+this.size.x/2))},
check:function(){},collideWith:function(){}});b.Entity._lastId=0;b.Entity.COLLIDES={NEVER:0,LITE:1,PASSIVE:2,ACTIVE:4,FIXED:8};b.Entity.TYPE={NONE:0,A:1,B:2,BOTH:3};b.Entity.checkPair=function(a,c){a.checkAgainst&c.type&&a.check(c);c.checkAgainst&a.type&&c.check(a);a.collides&&c.collides&&a.collides+c.collides>b.Entity.COLLIDES.ACTIVE&&b.Entity.solveCollision(a,c)};b.Entity.solveCollision=function(a,c){var d=null;if(a.collides==b.Entity.COLLIDES.LITE||c.collides==b.Entity.COLLIDES.FIXED)d=a;else if(c.collides==
b.Entity.COLLIDES.LITE||a.collides==b.Entity.COLLIDES.FIXED)d=c;a.last.x+a.size.x>c.last.x&&a.last.x<c.last.x+c.size.x?(a.last.y<c.last.y?b.Entity.seperateOnYAxis(a,c,d):b.Entity.seperateOnYAxis(c,a,d),a.collideWith(c,"y"),c.collideWith(a,"y")):a.last.y+a.size.y>c.last.y&&a.last.y<c.last.y+c.size.y&&(a.last.x<c.last.x?b.Entity.seperateOnXAxis(a,c,d):b.Entity.seperateOnXAxis(c,a,d),a.collideWith(c,"x"),c.collideWith(a,"x"))};b.Entity.seperateOnXAxis=function(a,c,d){var e=a.pos.x+a.size.x-c.pos.x;d?
(d.vel.x=-d.vel.x*d.bounciness+(a===d?c:a).vel.x,c=b.game.collisionMap.trace(d.pos.x,d.pos.y,d==a?-e:e,0,d.size.x,d.size.y),d.pos.x=c.pos.x):(d=(a.vel.x-c.vel.x)/2,a.vel.x=-d,c.vel.x=d,d=b.game.collisionMap.trace(a.pos.x,a.pos.y,-e/2,0,a.size.x,a.size.y),a.pos.x=d.pos.x.floor(),a=b.game.collisionMap.trace(c.pos.x,c.pos.y,e/2,0,c.size.x,c.size.y),c.pos.x=a.pos.x.ceil())};b.Entity.seperateOnYAxis=function(a,c,d){var e=a.pos.y+a.size.y-c.pos.y;if(d){c=a===d?c:a;d.vel.y=-d.vel.y*d.bounciness+c.vel.y;
var f=0;if(d==a&&Math.abs(d.vel.y-c.vel.y)<d.minBounceVelocity)d.standing=!0,f=c.vel.x*b.system.tick;a=b.game.collisionMap.trace(d.pos.x,d.pos.y,f,d==a?-e:e,d.size.x,d.size.y);d.pos.y=a.pos.y;d.pos.x=a.pos.x}else c.standing||a.vel.y>0?(d=b.game.collisionMap.trace(a.pos.x,a.pos.y,0,-(a.pos.y+a.size.y-c.pos.y),a.size.x,a.size.y),a.pos.y=d.pos.y,a.bounciness>0&&a.vel.y>a.minBounceVelocity?a.vel.y*=-a.bounciness:(a.standing=!0,a.vel.y=0)):(d=(a.vel.y-c.vel.y)/2,a.vel.y=-d,c.vel.y=d,f=c.vel.x*b.system.tick,
d=b.game.collisionMap.trace(a.pos.x,a.pos.y,f,-e/2,a.size.x,a.size.y),a.pos.y=d.pos.y,a=b.game.collisionMap.trace(c.pos.x,c.pos.y,0,e/2,c.size.x,c.size.y),c.pos.y=a.pos.y)}});b.module("g.game").requires("g.main").defines(function(){b.Game=b.Class.extend({clearColor:"#000000",gravity:0,screen:{x:0,y:0},entities:[],namedEntities:{},backgroundMaps:[],backgroundAnims:{},cellSize:64,run:function(){this.update();this.draw()},update:function(){for(var a=0;a<this.entities.length;a++)this.entities[a].update();
this.checkEntities();for(var b in this.backgroundAnims){var a=this.backgroundAnims[b],d;for(d in a)a[d].update()}for(a=0;a<this.backgroundMaps.length;a++)this.backgroundMaps[a].setScreenPos(this.screen.x,this.screen.y)},draw:function(){b.system.clear(this.clearColor);for(var a=0;a<this.backgroundMaps.length;a++)this.backgroundMaps[a].draw();for(a=0;a<this.entities.length;a++)this.entities[a].draw()},spawnEntity:function(a,c,d,e){var f=typeof a==="string"?b.global[a]:a;if(!f)throw"Can't spawn entity of type "+
a;a=new f(c,d,e||{});this.entities.push(a);e&&e.name&&(this.namedEntities[e.name]=a);return a},removeEntity:function(a){a.name&&delete this.namedEntities[a.name];this.entities.erase(a)},sortEntities:function(){this.entities.sort(function(a,b){return a.zIndex-b.zIndex})},getEntityByName:function(a){return this.namedEntities[a]},getEntitiesByType:function(a){for(var a=typeof a==="string"?b.global[a]:a,c=[],d=0;d<this.entities.length;d++)this.entities[d]instanceof a&&c.push(this.entities[d]);return c},
entitiesUnderMouse:function(){for(var a=ig.input.mouse.x,b=ig.input.mouse.y,d=this.entities,e=[],f=0;f<d.length;f+=1){var g=d[f],i=g.pos.x,h=g.pos.y;i<=a&&a<=i+g.size.x&&h<=b&&b<=h+g.size.y&&e.push(g)}return e},checkEntities:function(){for(var a={},c=0;c<this.entities.length;c++){var d=this.entities[c];if(!(c.type==b.Entity.TYPE.NONE&&c.checkAgainst==b.Entity.TYPE.NONE&&c.collides==b.Entity.COLLIDES.NEVER))for(var e={},f=(d.pos.x/this.cellSize).floor(),g=(d.pos.y/this.cellSize).floor(),i=((d.pos.x+
d.size.x)/this.cellSize).floor()+1,h=((d.pos.y+d.size.y)/this.cellSize).floor()+1;f<i;f++)for(var k=g;k<h;k++)if(a[f])if(a[f][k]){for(var j=a[f][k],m=0;m<j.length;m++)d.touches(j[m])&&!e[j[m].id]&&(e[j[m].id]=!0,b.Entity.checkPair(d,j[m]));j.push(d)}else a[f][k]=[d];else a[f]={},a[f][k]=[d]}}})});b.module("g.debug.menu").requires("dom.ready","g.system").defines(function(){b.System.inject({run:function(){b.debug.beforeRun();this.parent();b.debug.afterRun()},setGameNow:function(a){this.parent(a);b.debug.ready()}});
b.Debug=b.Class.extend({options:{},panels:{},numbers:{},container:null,panelMenu:null,activePanel:null,debugTime:0,debugTickAvg:0.016,debugRealTime:Date.now(),init:function(){var a=b.$new("link");a.rel="stylesheet";a.type="text/css";a.href="assets/g.debug.css";b.$("body").appendChild(a);this.container=b.$new("div");this.container.className="g_debug";b.$("body").appendChild(this.container);this.panelMenu=b.$new("div");this.panelMenu.innerHTML='<div class="g_debug_head">Debug:</div>';this.panelMenu.className=
"g_debug_panel_menu";this.container.appendChild(this.panelMenu);this.numberContainer=b.$new("div");this.numberContainer.className="g_debug_stats";this.panelMenu.appendChild(this.numberContainer);if(h.console&&h.console.log)b.log=h.console.log.bind(h.console);b.show=this.showNumber.bind(this)},addNumber:function(a){var c=b.$new("span");this.numberContainer.appendChild(c);this.numberContainer.appendChild(document.createTextNode(a));this.numbers[a]=c},showNumber:function(a,b,d){this.numbers[a]||this.addNumber(a,
d);this.numbers[a].textContent=b},addPanel:function(a){var c=new a.type(a.name,a.label);if(a.options)for(var d=0;d<a.options.length;d++){var e=a.options[d];c.addOption(new b.DebugOption(e.name,e.object,e.property))}this.panels[c.name]=c;c.container.style.display="none";this.container.appendChild(c.container);a=b.$new("div");a.className="g_debug_menu_item";a.textContent=c.label;a.addEventListener("click",function(a){this.togglePanel(a,c)}.bind(this),!1);c.menuItem=a;e=!1;for(d=1;d<this.panelMenu.childNodes.length;d++){var f=
this.panelMenu.childNodes[d];if(f.textContent>c.label){this.panelMenu.insertBefore(a,f);e=!0;break}}e||this.panelMenu.appendChild(a)},togglePanel:function(a,b){if(b!=this.activePanel&&this.activePanel)this.activePanel.toggle(!1),this.activePanel.menuItem.className="g_debug_menu_item",this.activePanel=null;var d=b.container.style.display!="block";b.toggle(d);a.target.className="g_debug_menu_item"+(d?" active":"");if(d)this.activePanel=b},ready:function(){for(var a in this.panels)this.panels[a].ready()},
beforeRun:function(){var a=Date.now();this.debugTickAvg=this.debugTickAvg*0.8+(a-this.debugRealTime)*0.2;this.debugRealTime=a;this.activePanel&&this.activePanel.beforeRun()},afterRun:function(){this.debugTime=this.debugTime*0.8+(Date.now()-this.debugRealTime)*0.2;this.activePanel&&this.activePanel.afterRun();this.showNumber("ms",this.debugTime.toFixed(2));this.showNumber("fps",Math.round(1E3/this.debugTickAvg));this.showNumber("draws",b.Image.drawCount);b.game&&b.game.entities&&this.showNumber("entities",
b.game.entities.length);b.Image.drawCount=0}});b.DebugPanel=b.Class.extend({active:!1,container:null,options:[],panels:[],label:"",name:"",init:function(a,c){this.name=a;this.label=c;this.container=b.$new("div");this.container.className="g_debug_panel "+this.name},toggle:function(a){this.active=a;this.container.style.display=a?"block":"none"},addPanel:function(a){this.panels.push(a);this.container.appendChild(a.container)},addOption:function(a){this.options.push(a);this.container.appendChild(a.container)},
ready:function(){},beforeRun:function(){},afterRun:function(){}});b.DebugOption=b.Class.extend({name:"",labelName:"",className:"g_debug_option",label:null,mark:null,container:null,active:!1,colors:{enabled:"#fff",disabled:"#444"},init:function(a,c,d){this.name=a;this.object=c;this.property=d;this.active=this.object[this.property];this.container=b.$new("div");this.container.className="g_debug_option";this.label=b.$new("span");this.label.className="g_debug_label";this.label.textContent=this.name;this.mark=
b.$new("span");this.mark.className="g_debug_label_mark";this.container.appendChild(this.mark);this.container.appendChild(this.label);this.container.addEventListener("click",this.click.bind(this),!1);this.setLabel()},setLabel:function(){this.mark.style.backgroundColor=this.active?this.colors.enabled:this.colors.disabled},click:function(a){this.active=!this.active;this.object[this.property]=this.active;this.setLabel();a.stopPropagation();a.preventDefault();return!1}});b.debug=new b.Debug});b.module("g.debug.entities-panel").requires("g.debug.menu",
"g.entity").defines(function(){b.Entity.inject({colors:{names:"#fff",velocities:"#0f0",boxes:"#f00"},draw:function(){this.parent();if(b.Entity._debugShowBoxes)b.system.context.strokeStyle=this.colors.boxes,b.system.context.lineWidth=1,b.system.context.strokeRect(b.system.getDrawPos(this.pos.x.round()-b.game.screen.x)-0.5,b.system.getDrawPos(this.pos.y.round()-b.game.screen.y)-0.5,this.size.x*b.system.scale,this.size.y*b.system.scale);if(b.Entity._debugShowVelocities){var a=this.pos.x+this.size.x/
2,c=this.pos.y+this.size.y/2;this._debugDrawLine(this.colors.velocities,a,c,a+this.vel.x,c+this.vel.y)}if(b.Entity._debugShowNames){if(this.name)b.system.context.fillStyle=this.colors.names,b.system.context.fillText(this.name,b.system.getDrawPos(this.pos.x-b.game.screen.x),b.system.getDrawPos(this.pos.y-b.game.screen.y));if(typeof this.target=="object")for(var d in this.target)(a=b.game.getEntityByName(this.target[d]))&&this._debugDrawLine(this.colors.names,this.pos.x+this.size.x/2,this.pos.y+this.size.y/
2,a.pos.x+a.size.x/2,a.pos.y+a.size.y/2)}},_debugDrawLine:function(a,c,d,e,f){b.system.context.strokeStyle=a;b.system.context.lineWidth=1;b.system.context.beginPath();b.system.context.moveTo(b.system.getDrawPos(c-b.game.screen.x),b.system.getDrawPos(d-b.game.screen.y));b.system.context.lineTo(b.system.getDrawPos(e-b.game.screen.x),b.system.getDrawPos(f-b.game.screen.y));b.system.context.stroke();b.system.context.closePath()}});b.Entity._debugEnableChecks=!0;b.Entity._debugShowBoxes=!1;b.Entity._debugShowVelocities=
!1;b.Entity._debugShowNames=!1;b.Entity.oldCheckPair=b.Entity.checkPair;b.Entity.checkPair=function(a,c){b.Entity._debugEnableChecks&&b.Entity.oldCheckPair(a,c)};b.debug.addPanel({type:b.DebugPanel,name:"entities",label:"Entities",options:[{name:"Checks & Collisions",object:b.Entity,property:"_debugEnableChecks"},{name:"Show Collision Boxes",object:b.Entity,property:"_debugShowBoxes"},{name:"Show Velocities",object:b.Entity,property:"_debugShowVelocities"},{name:"Show Names & Targets",object:b.Entity,
...
[];this.container.innerHTML="";for(a=0;a<this.maps.length;a++){var c=this.maps[a],d=new b.DebugPanel(a,"Layer "+a),e=new b.$new("strong");e.textContent=a+": "+c.tiles.path;d.container.appendChild(e);d.addOption(new b.DebugOption("Enabled",c,"enabled"));d.addOption(new b.DebugOption("Pre Rendered",c,"preRender"));d.addOption(new b.DebugOption("Show Chunks",c,"debugChunks"));this.generateMiniMap(d,c,a);this.addPanel(d)}}},generateMiniMap:function(a,c,d){var e=b.system.scale,f=b.$new("canvas"),g=f.getContext("2d"),
i=c.tiles.width*e,h=c.tiles.height*e,k=i/c.tilesize;g.drawImage(c.tiles.data,0,0,i,h,0,0,k,h/c.tilesize);g=b.$new("canvas");g.width=c.width*e;g.height=c.height*e;var j=g.getContext("2d");if(b.game.clearColor)j.fillStyle=b.game.clearColor,j.fillRect(0,0,i,h);for(h=i=0;h<c.width;h++)for(var m=0;m<c.height;m++)(i=c.data[m][h])&&j.drawImage(f,Math.floor((i-1)*e%k),Math.floor((i-1)*e/k)*e,e,e,h*e,m*e,e,e);f=b.$new("div");f.className="g_debug_map_container";f.style.width=c.width*e+"px";f.style.height=c.height*
e+"px";k=b.$new("div");k.className="g_debug_map_screen";k.style.width=b.system.width/c.tilesize*e-2+"px";k.style.height=b.system.height/c.tilesize*e-2+"px";this.mapScreens[d]=k;f.appendChild(g);f.appendChild(k);a.container.appendChild(f)},afterRun:function(){for(var a=b.system.scale,c=0;c<this.maps.length;c++){var d=this.maps[c],e=this.mapScreens[c];if(d&&e){var f=d.scroll.x/d.tilesize,g=d.scroll.y/d.tilesize;d.repeat&&(f%=d.width,g%=d.height);e.style.left=f*a+"px";e.style.top=g*a+"px"}}}});b.debug.addPanel({type:b.DebugMapsPanel,
name:"maps",label:"Background Maps"})});b.module("g.debug.graph-panel").requires("g.debug.menu","g.system","g.game","g.image").defines(function(){b.Game.inject({draw:function(){b.graph.beginClock("draw");this.parent();b.graph.endClock("draw")},update:function(){b.graph.beginClock("update");this.parent();b.graph.endClock("update")},checkEntities:function(){b.graph.beginClock("checks");this.parent();b.graph.endClock("checks")}});b.DebugGraphPanel=b.DebugPanel.extend({clocks:{},marks:[],textY:0,height:128,
ms:64,timeBeforeRun:0,init:function(a,c){this.parent(a,c);this.mark16ms=(this.height-this.height/this.ms*16).round();this.mark33ms=(this.height-this.height/this.ms*33).round();this.msHeight=this.height/this.ms;this.graph=b.$new("canvas");this.graph.width=h.innerWidth;this.graph.height=this.height;this.container.appendChild(this.graph);this.ctx=this.graph.getContext("2d");this.ctx.fillStyle="#444";this.ctx.fillRect(0,this.mark16ms,this.graph.width,1);this.ctx.fillRect(0,this.mark33ms,this.graph.width,
1);this.addGraphMark("16ms",this.mark16ms);this.addGraphMark("33ms",this.mark33ms);this.addClock("draw","Draw","#13baff");this.addClock("update","Entity Update","#bb0fff");this.addClock("checks","Entity Checks & Collisions","#a2e908");this.addClock("lag","System Lag","#f26900");b.mark=this.mark.bind(this);b.graph=this},addGraphMark:function(a,c){var d=b.$new("span");d.className="g_debug_graph_mark";d.textContent=a;d.style.top=c.round()+"px";this.container.appendChild(d)},addClock:function(a,c,d){var e=
b.$new("span");e.className="g_debug_legend_color";e.style.backgroundColor=d;var f=b.$new("span");f.className="g_debug_legend_number";f.appendChild(document.createTextNode("0"));var g=b.$new("span");g.className="g_debug_legend";g.appendChild(e);g.appendChild(document.createTextNode(c+" ("));g.appendChild(f);g.appendChild(document.createTextNode("ms)"));this.container.appendChild(g);this.clocks[a]={description:c,color:d,current:0,start:Date.now(),avg:0,html:f}},beginClock:function(a,b){this.clocks[a].start=
Date.now()+(b||0)},endClock:function(a){a=this.clocks[a];a.current=Math.round(Date.now()-a.start);a.avg=a.avg*0.8+a.current*0.2},mark:function(a,b){this.active&&this.marks.push({msg:a,color:b||"#fff"})},beforeRun:function(){this.endClock("lag");this.timeBeforeRun=Date.now()},afterRun:function(){var a=Date.now()-this.timeBeforeRun;this.beginClock("lag",Math.max(1E3/b.system.fps-a,0));var a=this.graph.width-1,c=this.height;this.ctx.drawImage(this.graph,-1,0);this.ctx.fillStyle="#000";this.ctx.fillRect(a,
0,1,this.height);this.ctx.fillStyle="#444";this.ctx.fillRect(a,this.mark16ms,1,1);this.ctx.fillStyle="#444";this.ctx.fillRect(a,this.mark33ms,1,1);for(var d in this.clocks){var e=this.clocks[d];e.html.textContent=e.avg.toFixed(2);if(e.color&&e.current>0){this.ctx.fillStyle=e.color;var f=e.current*this.msHeight;c-=f;this.ctx.fillRect(a,c,1,f);e.current=0}}this.ctx.textAlign="right";this.ctx.textBaseline="top";this.ctx.globalAlpha=0.5;for(d=0;d<this.marks.length;d++)if(c=this.marks[d],this.ctx.fillStyle=
c.color,this.ctx.fillRect(a,0,1,this.height),c.msg)this.ctx.fillText(c.msg,a-1,this.textY),this.textY=(this.textY+8)%32;this.ctx.globalAlpha=1;this.marks=[]}});b.debug.addPanel({type:b.DebugGraphPanel,name:"graph",label:"Performance"})});b.module("g.animation-debug-panel").requires("g.debug.menu","g.entity","g.game").defines(function(){b.Game.inject({loadLevel:function(a){this.parent(a);b.debug.panels.animationpanel.load(this)}});b.Entity.inject({_shouldUpdate:!0,update:function(){this._shouldUpdate&&
this.parent()}});AnimationDebugPanel=b.DebugPanel.extend({init:function(a,b){this.parent(a,b);this.container.innerHTML="<em>Entities not loaded yet.</em>"},load:function(a){this.container.innerHTML="";for(var b=0;b<a.entities.length;b++){var d=a.entities[b];d.name&&this.addOption(new ig.DebugOption("Entity "+d.name,d,"_shouldUpdate"))}},ready:function(){},beforeRun:function(){},afterRun:function(){}});b.debug.addPanel({type:AnimationDebugPanel,name:"Animationpanel",label:"Animation"})});b.module("g.debug").requires("g.debug.entities-panel",
"g.debug.maps-panel","g.debug.graph-panel").defines(function(){});if(typeof h!=="undefined")h._g=b})(window);Number.prototype.map=function(h,b,n,o){return n+(o-n)*((this-h)/(b-h))};Number.prototype.limit=function(h,b){return Math.min(b,Math.max(h,this))};Number.prototype.round=function(h){h=Math.pow(10,h||0);return Math.round(this*h)/h};Number.prototype.floor=function(){return Math.floor(this)};Number.prototype.ceil=function(){return Math.ceil(this)};
Number.prototype.toInt=function(){return this|0};Array.prototype.erase=function(h){for(var b=this.length;b--;)this[b]===h&&this.splice(b,1);return this};Array.prototype.random=function(){return this[(Math.random()*this.length).floor()]};Function.prototype.bind=function(h){var b=this;return function(){var n=Array.prototype.slice.call(arguments);return b.apply(h||null,n)}};
