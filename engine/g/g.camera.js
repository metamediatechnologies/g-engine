...
/*
 * Shows only part of view - to obtain move around effect for 2d graphics
 */
...
.defines(function () {
    ...
    Camera = _g.Class.extend({
        ...
        move: function (axis, pos, size) {
            ...
            return (this.pos[axis] - (this.pos[axis] - this.trap.pos[axis]
                                      + this.offset[axis]
                                      + this.currentLookAhead[axis]) * ig.system.tick * this.damping)
