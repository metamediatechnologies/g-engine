    ...
    .defines(function () {
        _g.SoundManager = _g.Class.extend({
            ...
            load: function (path, multiChannel, loadCallback) {
                ...
                var realPath = path.match(/^(.*)\.\w+$/)[1] + '.' + this.format + _g.nocache;
                var clip = _g.$new('audio');
                if (loadCallback) {
        ...
        _g.Music = _g.Class.extend({
            ...
            add: function (music) {
                ...
                var path = music instanceof _g.Sound ? music.path : music;
                var track = _g.soundManager.load(path, false);
            ...
            fadeOut: function (time) {
                ...
                this.fadeTimer = new _g.Timer(time);
        ...
        _g.Sound = _g.Class.extend({
            ...
            load: function (loadCallback) {
                ...
                if (_g.ready) {
                    _g.soundManager.load(this.path, this.multiChannel, loadCallback);
                } else {
                    _g.addResource(this);
                }
            },
            play: function () {
                ...
                this.currentClip = _g.soundManager.get(this.path);
                this.currentClip.volume = _g.soundManager.volume * this.volume;
